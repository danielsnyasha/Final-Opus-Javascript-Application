...
import mobileBevel from '../../pictures/ImagesJade/mobileBevel.jpg';
    ...
    return (
        <div className="machContainer">
            ...
            {/* <div className="matchTop">
                <img className="mtImage" src={mobileBevel}></img>
            </div> */}
            <div className="machInner">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Mobile Bevelling Machine</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">BENZONI 437614</h1>
                    </div>
                </div>
