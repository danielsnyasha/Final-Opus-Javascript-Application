...
import ThreeRoll from '../../pictures/ImagesJade/3roll.jpg';
...
{/* <div className="matchTop">
        <img className="mtImage" src={ThreeRoll}></img>
      </div> */}
        ...
        <img src={back} alt="" className="backImage1" onClick={toBack}></img>
            ...
            <div className="machInner">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">3 Roll Machine</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Custom Built</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">1100mm</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
