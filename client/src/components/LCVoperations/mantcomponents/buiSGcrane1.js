...
import sg1 from '../../pictures/ImagesJade/sg1.jpg';
...
function Sg1() {
    ...
    return (
        ...
        {/* <div className="matchTop">
                <img className="mtImage" src={sg1}></img>
            </div> */}
            ...
            <div className="machInner">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Diesel Generator</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">38kVA</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Guard 3</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
