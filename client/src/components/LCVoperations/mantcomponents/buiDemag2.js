...
import demag3 from '../../pictures/ImagesJade/demag1.jpg';
    ...
    return (
        <div className="machContainer">
            {/* <div className="matchTop">
                <img className="mtImage" src={demag3}></img>
            </div> */}
            ...
            <div className="machInner">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Demag Overhead Crane</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">10 Tonne</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
