...
import beyeler from '../../pictures/ImagesJade/beyeler.jpg';
...
function Beyeller() {
    ...
    return (
        ...
        <img className="mtImage" src={beyeler}></img>
      </div> */}
        ...
        <img src={back} alt="" className="backImage1" onClick={toBack}></img>
            ...
            <div className="machInner">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Bystronic Beyeller</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">550mm</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">265mm</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
