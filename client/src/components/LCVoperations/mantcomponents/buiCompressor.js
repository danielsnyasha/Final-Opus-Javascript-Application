...
import compressor from '../../pictures/ImagesJade/COMPRESSOR.jpg';
...
{/* <div className="matchTop">
                <img className="mtImage" src={compressor}></img>
            </div> */}
            ...
            <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Compressor</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Atlas Copco</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">GA 50 VSD OFF</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">13 Bar/67 Hp</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    <h1 className="machText">Bought in (year)</h1>
                    </div>
                    <div className="machCont">
