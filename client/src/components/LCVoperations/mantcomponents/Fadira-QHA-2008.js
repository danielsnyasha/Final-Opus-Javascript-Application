...
import Adira1 from '../../pictures/ImagesJade/adira1.jpg'
...
function Adira() {
    ...
    return (
        ...
        <img className="mtImage" src={Adira1}></img>
      </div> */}
        ...
        <img src={back} alt="" className="backImage1" onClick={toBack}></img>
            ...
            <div className="machInner">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">Adir-QHA-2008</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">800mm</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                ...
                <div className="mdivs">
                    ...
                    <div className="machCont">
                    <h1 className="machText">120mm</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
                    ...
                    <div className="machCont">
                    <h1 className="machText">100mm</h1>
                    </div>
                </div>
                <div className="mdivs">
                    <div className="machCont">
